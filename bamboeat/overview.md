...
Vanilla Minecraft ignores bamboo as a food source entirely. BambEat fixes that — players can hold bamboo and eat it like any other food item, complete with a satisfying crunch, custom particles, and fully configurable hunger and effect values.
...
Out of the box, BambEat turns bamboo into a proper food item. Right-click to eat, hear the crunch, see the particles, get the hunger back. Everything about how it behaves — hunger restored, saturation, cooldown, potion effects — is yours to configure.
...
**Permission-gated**
Control who can eat bamboo with a single permission node — useful for gamemodes or progression systems.
