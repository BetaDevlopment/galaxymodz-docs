...
**Q: Does disguising as a mob affect hitbox size?**
A: No. The hitbox remains the player's standard size regardless of the mob chosen.
...
**Q: Is Guise compatible with tab list plugins?**
A: Guise does not modify the tab list by default. Compatibility with tab plugins depends on how those plugins read player data.
