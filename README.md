...
GalaxyModz is a collaborative development project focused on delivering well-documented, performance-first plugins for Paper/Spigot servers. Every project ships with full configuration references, command lists, and permission nodes.
...
Head to any plugin's **Overview** page to learn what it does, or jump straight to **Installation** if you know what you need.

Each plugin section covers:
- Overview & features
- Installation & requirements
- Commands & permissions
- Configuration reference
- FAQ / additional guides

---

*Documentation maintained by GalaxyModz & Frostbyte*
